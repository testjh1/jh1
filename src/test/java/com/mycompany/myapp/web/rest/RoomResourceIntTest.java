...
public class RoomResourceIntTest {
    ...
    private static final Long DEFAULT_NUMBER_AUDIENCE = 1L;
    private static final Long UPDATED_NUMBER_AUDIENCE = 2L;
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room()
                .numberAudience(DEFAULT_NUMBER_AUDIENCE);
        return room;
    }
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.getNumberAudience()).isEqualTo(DEFAULT_NUMBER_AUDIENCE);
    }

    @Test
    @Transactional
    public void checkNumberAudienceIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumberAudience(null);
    ...
    public void getAllRooms() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].numberAudience").value(hasItem(DEFAULT_NUMBER_AUDIENCE.intValue())));
    }
    ...
    public void getRoom() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms/{id}", room.getId()))
            ...
            .andExpect(jsonPath("$.numberAudience").value(DEFAULT_NUMBER_AUDIENCE.intValue()));
    }
    ...
    public void updateRoom() throws Exception {
        ...
        updatedRoom
                .numberAudience(UPDATED_NUMBER_AUDIENCE);
        ...
        Room testRoom = rooms.get(rooms.size() - 1);
        assertThat(testRoom.getNumberAudience()).isEqualTo(UPDATED_NUMBER_AUDIENCE);
    }
